...
describe('PaymentService', () => {
  ...
  let pdfService: any;
  let workflowsServiceMock: Partial<WorkflowsService>;
  ...
  beforeEach(() => {
    ...
    workflowsServiceMock = {
      ensureInitialWorkflowForRequests: jest.fn().mockResolvedValue(1),
    };
    ...
    service = new PaymentService(
      ...
      workflowsServiceMock as WorkflowsService,
    );
  });
  ...
  it('marks payment successful after valid signature verification and activates the service', async () => {
    ...
    expect(
      workflowsServiceMock.ensureInitialWorkflowForRequests,
