...
export declare class CatalogQueryService {
    private readonly serviceCategoriesRepository;
    private readonly servicesRepository;
    constructor(serviceCategoriesRepository: Repository<ServiceCategoryEntity>, servicesRepository: Repository<ServiceEntity>);
