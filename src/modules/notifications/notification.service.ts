...
export class NotificationService {
  ...
  constructor(
    ...
    const twilioConfig =
      this.configService.get<AppEnvironment['twilio']>('app.twilio');
  ...
  async sendSms(to: string, body: string) {
    ...
    const twilioConfig =
      this.configService.getOrThrow<AppEnvironment['twilio']>('app.twilio');
  ...
  sendPaymentSuccessNotification(
    ...
    return this.sendEmail(
      user.email,
      'Payment Successful - DoorstepFilings',
      'payment-success',
      {
        userName: user.name ?? 'User',
  ...
  sendRefundNotification(
    ...
    return this.sendEmail(
      user.email,
      'Refund Initiated - DoorstepFilings',
      'refund',
      {
        userName: user.name ?? 'User',
  ...
  sendRegisterOtpNotification(to: string, otp: string) {
    return this.sendEmail(to, 'Your DoorstepFilings OTP', 'register-otp', {
      otp,
    });
  }
