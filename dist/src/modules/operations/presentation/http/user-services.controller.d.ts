...
export declare class UserServicesController {
    private readonly userServicesService;
    constructor(userServicesService: UserServicesService);
    getMyServices(authUser: {
        userId: number;
    }): Promise<{
        success: boolean;
        message: string;
    ...
    applyForService(authUser: {
        userId: number;
    }, body: Record<string, unknown>, files?: UploadedDocumentFile[]): Promise<{
        success: boolean;
        message: string;
        data: {
            id: number;
    ...
    uploadMyDocuments(authUser: {
        userId: number;
    }, id: number, body: Record<string, unknown>, files?: UploadedDocumentFile[]): Promise<{
        success: boolean;
        message: string;
        data: {
            id: number;
    ...
    deleteMyDocument(authUser: {
        userId: number;
    }, id: number, docId: number): Promise<{
        success: boolean;
        message: string;
        data: null;
    }>;
